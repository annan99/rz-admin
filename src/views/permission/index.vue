  ...
  <div class="dashboard-container">
    <div class="app-container">
      <PageTool style="margin-bottom:20px">
        <template #right>
          <el-button type="primary" size="mini" @click="showDialog('0')">添加权限</el-button>
        </template>
      </PageTool>
      ...
      <el-card>
        ...
        <el-table-column label="操作">
          <template v-slot="scope">
            <el-button type="text" v-if="scope.row.type===1" @click="showDialog(scope.row.id)">添加</el-button>
    ...
    <el-dialog :title="title" :visible.sync="dialogVisible" @close="reset">
      <el-form label-width="100px" :model="permissionForm" :rules="permissionFormRules" ref="permissionRef">
